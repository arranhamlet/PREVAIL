...
#'
#' Initializes a dust model system using the provided parameters, runs the simulation
...
#' @param simulation_length Integer. The number of time steps to simulate (default is 1000). Time starts at 0.
