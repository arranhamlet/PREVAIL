...
Once this is done, we can start thinking about the data we would like to customise. Here we are going to be focussing on vaccination and vaccine associated parameters. These are:
...
# 2. Customising our vaccination parameters
