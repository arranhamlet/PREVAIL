...
param_packager <- function(
    ...
    cfr_normal = 0, cfr_severe = 0, cfr_normal_real = 0, cfr_severe_real = 0, population, female_population,
    repro_weight
) {
  ...
  params <- list(
    ...
    prop_complications = format_array(prop_complications, dims_3d),
    ...
    cfr_normal = format_array(cfr_normal, dims_3d),
    cfr_severe = format_array(cfr_severe, dims_3d),
    cfr_normal_real = format_array(cfr_normal_real, dims_3d),
    cfr_severe_real = format_array(cfr_severe_real, dims_3d),
    ...
    repro_weight = format_array(repro_weight, c(n_age, length(tt_birth_changes)))
  )
